# Test Review Patterns: DB Adapter Layer (Java/Spring)
...
## Java-Specific Rules (DB/Persistence)
...
- **Testcontainers lifecycle** -- `@DbTest` + `DbContainerTestExecutionListener` auto-manages PostgreSQL container
