...
2. Search the backend's REST adapter package (consult the backend tech profile for its location and annotation/decorator syntax) for a controller mapping that matches the method and path
