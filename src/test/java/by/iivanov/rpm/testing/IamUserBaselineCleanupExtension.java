 ...
 * test. Resolves the {@link DataSource} from the Spring {@link ExtensionContext} and runs the delete
 * through {@link JdbcClient}, keeping the DB-cleanup responsibility out of the shared context base.
 */
