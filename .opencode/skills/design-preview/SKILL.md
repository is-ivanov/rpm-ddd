...
- **Approve and ADR**: mark `design` step as `[x]`, then write an ADR using `.opencode/templates/spec/adr-format.md` to the story's `decisions/` subfolder. Commit includes the ADR file.
